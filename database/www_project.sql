...
CREATE TABLE IF NOT EXISTS `orders` (
  `orderid` int(25) unsigned NOT NULL,
  `customerid` int(25) unsigned NOT NULL,
  ...
  `country` char(20) COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;


INSERT INTO `orders` (`orderid`, `customerid`, `amount`, `date`, `name`, `address`, `city`, `zip_code`, `country`) VALUES
...
ALTER TABLE `orders`
  MODIFY `orderid` int(50) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;

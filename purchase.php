...
?>
	...
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="card_number" class="col-lg-2 control-label">Address</label>
            <div class="col-lg-10">
              	<input type="text" class="form-control" name="address">
            </div>
        </div>
        <div class="form-group">
            <label for="card_PID" class="col-lg-2 control-label">City</label>
            <div class="col-lg-10">
              	<input type="text" class="form-control" name="city">
            </div>
        </div>
        <div class="form-group">
            <label for="card_expire" class="col-lg-2 control-label">zip code</label>
            <div class="col-lg-10">
              	<input type="date" name="zip_code" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label for="card_expire" class="col-lg-2 control-label">country</label>
            <div class="col-lg-10">
		...
		<?php } ?>
        <div class="form-group">
            <label for="card_owner" class="col-lg-2 control-label">Name on Credit card</label>
            <div class="col-lg-10">

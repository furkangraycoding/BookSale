<?php
	function db_connect(){
		$conn = mysqli_connect("localhost", "root", "", "www.project");
		if(!$conn){
	...
	function insertIntoOrder($conn, $customerid, $total_price, $date, $name, $address, $city, $zip_code, $country){
		$query = "INSERT INTO orders VALUES 
		('', '" . $customerid . "', '" . $total_price . "', '" . $date . "', '" . $name . "', '" . $address . "', '" . $city . "', '" . $zip_code . "', '" . $country . "')";
		$result = mysqli_query($conn, $query);
